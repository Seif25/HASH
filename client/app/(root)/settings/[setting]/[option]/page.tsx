...
export default async function Page({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-6 mt-5 w-full h-full bg-accent2 rounded-xl">
      <div className="hidden lg:block col-span-1 lg:col-span-2 bg-accent2 lg:bg-accent1/10 h-full rounded-xl lg:rounded-l-lg lg:rounded-r-none w-full p-5">
      ...
      <div className="col-span-1 lg:col-span-4 bg-accent2 border border-accent border-l-transparent h-full rounded-xl lg:rounded-tl-none lg:rounded-bl-none w-full">
        <div className="flex flex-col gap-5 justify-center">
