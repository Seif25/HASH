...
export default function Premium({ sm = false }: { sm?: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-5 rounded-lg mt-5 bg-accent2 text-accent1">
      ...
      >
        <div className="flex flex-col gap-5 items-center justify-center border border-accent1/10 rounded-lg p-5">
        ...
        <div className="flex flex-col gap-5 items-center justify-center border border-accent1/10 rounded-lg p-5 bg-primary shadow-md shadow-primary/30">
